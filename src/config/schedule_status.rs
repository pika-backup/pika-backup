...
/// the device has been "in use" for 10 minutes *or* the accumulated in-use-time is higher
/// than 10 minutes. (to prevent backups from never running if the device is never in use for
