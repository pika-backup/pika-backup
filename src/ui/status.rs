...
impl Drop for QuitGuard {
    fn drop(&mut self) {
        ...
        glib::MainContext::default().invoke_local(move || {
            ...
            let new_count = status.quit_inhibit_count.get();
