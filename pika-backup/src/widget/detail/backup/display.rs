...
use crate::prelude::*;
use crate::widget::ExcludeDialog;
...
impl imp::BackupPage {
    ...
    pub fn refresh(&self) -> Result<()> {
        ...
        // include list
        crate::utils::clear(&self.include_list);
        ...
        // exclude list
        crate::utils::clear(&self.exclude_list);
    ...
    fn refresh_status_display(&self, status: &crate::backup_status::Display) {
        self.detail_status_row.set_from_backup_status(status);

        let running = matches!(&status.graphic, crate::backup_status::Graphic::Spinner);
